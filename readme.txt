...
= 1.0.2 =
* Fix: cookie domain now set to root domain (matches JS script behaviour)
* Fix: empty clickIds preserved as object, not array
* Fix: landing page URLs no longer escaped with backslashes
